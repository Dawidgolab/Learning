...
root.bind('<a>',my_message_1) #This action works after click the screen
# we have e.g. <A> if we want it to work with the letter A 
root.bind("<a>",my_message_2, add="+") # this method help us to use the secound function after first one
root.mainloop()